...
static function float GetMagCapacityModStatic(KFPlayerReplicationInfo KFPRI, class<KFWeapon> Other)
{
        ...
        )
    {
        if ( GetClientVeteranSkillLevel(KFPRI) > 6 )
            ...
            return 1.0501 + 0.05 * GetClientVeteranSkillLevel(KFPRI);
    }
	return 1.0;
}
...
defaultproperties
{
    ...
    SRLevelEffects(0)="*** BONUS LEVEL 0 (HTec v3.50)|5% more damage with ZED Guns|5% faster freezing|5% larger ZED Gun clips|10% discount on HTec Inventory|Armor does not slow you down|Spawn with Cryo Grenades"
    SRLevelEffects(1)="*** BONUS LEVEL 1 (HTec v3.50)|10% more damage with ZED/Cryo Guns|10% faster freezing|10% larger ZED Gun clips|7% less damage from Bloat Bile and Siren Scream while wearing Horzine Armor (>100)|150% frozen dosh value|20% discount on HTec Inventory|Armor does not slow you down|Spawn with Cryo Grenades"
    SRLevelEffects(2)="*** BONUS LEVEL 2 (HTec v3.50)|20% more damage with ZED/Cryo Guns|20% faster freezing|15% larger ZED Gun clips|14% less damage from Bloat Bile and Siren Scream while wearing Horzine Armor (>100)|150% frozen dosh value|30% discount on HTec Inventory|Armor does not slow you down|Spawn with Cryo Grenades"
    SRLevelEffects(3)="*** BONUS LEVEL 3 (HTec v3.50)|30% more damage with ZED/Cryo Guns|30% faster freezing|20% larger ZED Gun clips|21% less damage from Bloat Bile and Siren Scream while wearing Horzine Armor (>100)|200% frozen dosh value|40% discount on HTec Inventory|Armor does not slow you down|Spawn with Cryo Grenades"
    SRLevelEffects(4)="*** BONUS LEVEL 4 (HTec v3.50)|40% more damage with ZED/Cryo Guns|40% faster freezing|25% larger ZED Gun clips|28% less damage from Bloat Bile and Siren Scream while wearing Horzine Armor (>100)|200% frozen dosh value|50% discount on HTec Inventory|Armor does not slow you down|Spawn with Cryo Grenades"
    SRLevelEffects(5)="*** BONUS LEVEL 5 (HTec v3.50)|50% more damage with ZED/Cryo Guns|50% faster freezing|30% larger ZED Gun clips|35% less damage from Bloat Bile and Siren Scream while wearing Horzine Armor (>100)|250% frozen dosh value|60% discount on HTec Inventory|Armor does not slow you down|Spawn with Cryo Grenades"
    SRLevelEffects(6)="*** BONUS LEVEL 6 (HTec v3.50)|60% more damage with ZED/Cryo Guns|60% faster freezing|35% larger ZED Gun clips|42% less damage from Bloat Bile and Siren Scream while wearing Horzine Armor (>100)|300% frozen dosh value|70% discount on HTec Inventory|Armor does not slow you down|Spawn with Cryo Grenades"
    CustomLevelInfo="*** BONUS LEVEL %L (HTec v3.50)|%s more damage with ZED Guns|%s faster freezing|35% larger ZED Gun clips|42% less damage from Bloat Bile and Siren Scream while wearing Horzine Armor (>100)|300% frozen dosh value|%d discount on HTec Inventory|Armor does not slow you down|Spawn with Cryo Grenades"
